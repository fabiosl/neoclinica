    ...
    <body>
		...
		<div align="center">
			<neo:linhaDeBotoes>
				...
				<neo:botao id="financas" link="relatorios/relatorioFinancaData" imgsrc="${resource(dir:'images/botoes',file:'relatorio.png')}" descricao="Relat&oacute;rios Financeiros"/>
			</neo:linhaDeBotoes>
    	</div>
    </body>
</html>