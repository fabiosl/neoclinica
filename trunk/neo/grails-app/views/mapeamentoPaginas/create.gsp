<head>
	...
	<title>Create MapeamentoPaginas</title>
</head>
...
<body>
	...
	<div class="nav">
		...
		<span class="menuButton"><g:link class="list" action="list">MapeamentoPaginas List</g:link></span>
	</div>

	<div class="body">
		<h1>Create MapeamentoPaginas</h1>
		...
		<g:form action="save">
			<div class="dialog">
				...
				<tbody>
					...
					<tr class="prop">
						<td valign="top" class="name"><label for="configAttribute">Hierarquia (comma-delimited):</label></td>
