...
<body>
	...
	<div class="nav">
		...
		<span class="menuButton"><g:link class="list" action="list">Hierarquia List</g:link></span>
		<span class="menuButton"><g:link class="create" action="create">New Hierarquia</g:link></span>
	</div>

	<div class="body">
		<h1>Edit Hierarquia</h1>
		...
		<g:form>
			...
			<tbody>
				<tr class="prop">
					<td valign="top" class="name"><label for="authority">Hierarquia Name:</label></td>
