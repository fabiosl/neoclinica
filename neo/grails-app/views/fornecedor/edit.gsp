                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="lentes"><g:message code="fornecedor.lentes.label" default="Lentes Fornecidas" /></label>
                                </td>
                                <td valign="top" class="value ${hasErrors(bean: fornecedorInstance, field: 'lentes', 'errors')}">
                                    <g:select name="lentes" from="${core.Lente.list()}" multiple="yes" optionKey="id" size="5" value="${fornecedorInstance?.lentes*.id}" />
                                </td>
                            </tr>
