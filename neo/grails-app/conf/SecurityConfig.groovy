security {
	...
	/medico/create**=ROLE_ADMIN, ROLE_MANUTENCAO
	/medico/edit**=ROLE_ADMIN, ROLE_FUNCIONARIO, ROLE_MANUTENCAO
	/medico/list**=ROLE_ADMIN, ROLE_FUNCIONARIO, ROLE_MANUTENCAO
	/medico/show**=ROLE_ADMIN, ROLE_FUNCIONARIO, ROLE_MANUTENCAO
	...
	/usuario=ROLE_ADMIN, ROLE_MANUTENCAO, ROLE_FUNCIONARIO
